    ...
    try {
      ...
      await fsp.writeFile(
        ...
        [
          ...
          "## Working method",
          "",
          "Both models are given this section verbatim at every stage. It narrows how work is",
          "done here; it cannot change the sequencing, which is code.",
          "",
          "- Talk before building. Nothing is written until Build is pressed.",
          "- Say what is undecided while it is still a conversation.",
          "- Do only what was asked; an unrequested change is a finding even when it improves",
          "  something.",
          "",
          "## Conventions",
          "",
